...
<div class="row mt-4">
                ...
                <div class="card shadow-lg">
                    <div class="card-header" style="background-color: #00c5fd">
                        <div class="row col-lg-12">
                            <div class="col-lg-0">
                                {{-- <a href="{{route('chat_admin')}}"><i class="mdi mdi-keyboard-backspace" style="color: white;font-size:30px;"></i></a> --}}
                                <a href="#" onclick="history.back()"><i class="mdi mdi-keyboard-backspace" style="color: white;font-size:30px;"></i></a>
                                
                                {{-- <img src="{{ asset('./images/'.$chatBox->HinhAnh)}}"  style="width:60px;height:60px;border-radius: 50%;" alt="">                    --}}
                            </div>
      ...
      <div class="w-50 d-flex justify-content-end">
        <div class="modal fade" id="modalAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered justify-content-center w-auto">
                {{-- START FORM --}}
                <form  method="post" action="{{route('addchat_admin')}}">
                    @csrf
                    <input type="hidden" name="phongchat" value="{{$chatBox->Id_ChatBox}}">
                    <div class="modal-content p-3" style="width: 550px;">
                        ...
                        <div class="d-flex flex-column w-auto mt-3">
                            <div class="d-flex text-left mb-2 align-items-center">
                                ...
                                <div class="w-75">
                                    <select name="nhanvienA" id=""  class="form-control" >
    ...
    <div class="w-50 d-flex justify-content-end">
        <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered justify-content-center w-auto">
                {{-- START FORM --}}
                <form  method="post" action="{{route('updatechat',['id'=>$chatBox->Id_ChatBox])}}">
                    @csrf
                    <div class="modal-content p-3" style="width: 550px;">
                        {{-- <input type="hidden" name="" class="form-control"/> --}}
                        <div class="d-flex flex-column w-auto mt-3">
    ...
    <input type="hidden" value="{{session()->get('admin_id')}}" id="nhanvien" name="nhanvien">
...
$(document).ready(function(){   
    ...
    setInterval(
        function(){
            $('#loaddata').load("/admin/chat/loadchat/" +id
                );
        }, 500);
